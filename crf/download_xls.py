...
def getData():
    ...
    before_evaluate_col_labels = ["评价日期","部位_0","部位_1","部位_2","部位_3","部位_4","测量方法_0","测量方法_1","测量方法_2","测量方法_3","测量方法_4","长径(mm)_0","长径(mm)_1","长径(mm)_2","长径(mm)_3","长径(mm)_4","评价日期","部位_0","部位_1","部位_2","部位_3","部位_4","部位_5","测量方法_0","测量方法_1","测量方法_2","测量方法_3","测量方法_4","测量方法_5","状态_0","状态_1","状态_2","状态_3","状态_4","状态_5","可评估病灶_0","可评估病灶_1","可评估病灶_2","可评估病灶_3","可评估病灶_4","可评估病灶_5"]
    treatment_col_labels = ["分组","首次治疗时间","末次治疗时间","一共完成化疗次数","化疗终止原因","病情进展日期(如果出现进展)","死亡日期(如果死亡)"]
    after_evaluate_col_labels = ["评价日期","部位_0","部位_1","部位_2","部位_3","部位_4","测量方法_0","测量方法_1","测量方法_2","测量方法_3","测量方法_4","长径(mm)_0","长径(mm)_1","长径(mm)_2","长径(mm)_3","长径(mm)_4","评价日期","部位_0","部位_1","部位_2","部位_3","部位_4","测量方法_0","测量方法_1","测量方法_2","测量方法_3","测量方法_4","状态（存在或消失）_0","状态（存在或消失）_1","状态（存在或消失）_2","状态（存在或消失）_3","状态（存在或消失）_4","可评估病灶_0","可评估病灶_1","可评估病灶_2","可评估病灶_3","可评估病灶_4","总疗效","评价日期"]
